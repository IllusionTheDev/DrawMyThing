...
public class Round {
    ...
    public Drawer pickDrawer()
    {
        ...
        drawer = new Drawer(main.getToolManager(), toDraw.size() == 1 ? toDraw.remove(0) : toDraw.remove(random.nextInt(toDraw.size())), "");
