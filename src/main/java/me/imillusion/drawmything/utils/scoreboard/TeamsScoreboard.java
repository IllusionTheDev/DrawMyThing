...
public class TeamsScoreboard {
    ...
    static {
        for (int i = 0; i < MAX_LINES; i++)
            BLANKS[i] = new String(new char[]{ChatColor.COLOR_CHAR, (char) ('r' + i)});
    }
    ...
    public int line(int index, Object text, int score) {
        ...
        String suffix = ColorConverter.getLastColors(prefix) + colored.substring(16);
     ...
     * @return - The index of the line.
     */
    public int line(int index, String text) { return line(index, text, 1); }
